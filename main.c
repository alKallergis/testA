...
/*Values are change to be used in WaterMeter with NAS layout use */
  
#define RF_SW_CTRL3_PIN                          GPIO_PIN_0
...
#define RF_SW_CTRL1_PIN                          GPIO_PIN_1
...
#define RF_SW_CTRL2_PIN                          GPIO_PIN_2
